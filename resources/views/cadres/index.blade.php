...
@section('content')
<section class="bg-gray-50 min-h-screen font-sans">
    ...
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12 -mt-12 relative z-20 pb-20">
        ...
        <div class="bg-white relative shadow-xl rounded-xl overflow-hidden border border-gray-100 mb-6">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-5">
                    ...
                    <form action="{{ route('cadres.index') }}" method="GET" class="flex items-center">
                        <div class="relative w-full">
                            ...
                            <input type="text" name="search" value="{{ $search ?? '' }}" 
                                class="bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-lg focus:ring-kzz-blue focus:border-kzz-blue block w-full pl-10 p-2.5" 
                ...
                <div class="w-full md:w-auto">
                    <button type="button" data-modal-target="add-cadre-modal" data-modal-toggle="add-cadre-modal" 
                        class="w-full flex items-center justify-center text-white bg-kzz-green hover:bg-green-700 font-black rounded-lg text-xs px-6 py-3 transition-all shadow-md uppercase tracking-widest">
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="bg-white hover:bg-blue-50/30 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <span class="text-kzz-blue font-black uppercase text-[10px] bg-blue-50 px-2 py-1 rounded border border-blue-100">{{ $cadre->fonction }}</span>
                            </td>
                            ...
                            <td class="px-6 py-4 flex items-center justify-end space-x-4">
                                ...
                                <form action="{{ route('cadres.destroy', $cadre) }}" method="POST" onsubmit="return confirm('Confirmer la suppression définitive ?')">
                                    @csrf @method('DELETE')
                                    <button type="submit" class="text-red-500 hover:text-red-700 transition-transform group-hover:scale-110">
            ...
            <div class="p-4 bg-gray-50 border-t border-gray-100">
                {{ $cadres->appends(['search' => $search])->links() }}
            </div>
        </div>
    </div>
</section>
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        <form action="{{ route('cadres.store') }}" method="POST" enctype="multipart/form-data" class="relative bg-white rounded-xl shadow-2xl overflow-hidden">
            ...
            <div class="flex items-start justify-between p-5 border-b bg-kzz-blue">
                ...
                <button type="button" data-modal-hide="add-cadre-modal" class="text-white/70 hover:text-white">
            ...
            <div class="p-8 space-y-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block mb-2 text-xs font-black text-gray-700 uppercase tracking-widest">Nom Complet</label>
                        <input type="text" name="nom_complet" class="bg-gray-50 border border-gray-200 text-sm rounded-lg w-full p-3 focus:ring-kzz-blue focus:border-kzz-blue" placeholder="Ex: Jean Mukendi" required>
                    </div>
                    <div>
                        <label class="block mb-2 text-xs font-black text-gray-700 uppercase tracking-widest">Fonction dans l'ONG</label>
                ...
                <div>
                    <label class="block mb-2 text-xs font-black text-gray-700 uppercase tracking-widest">Profession (Titre)</label>
                ...
                <div>
                    <label class="block mb-2 text-xs font-black text-gray-700 uppercase tracking-widest">Biographie / Parcours</label>
                    <textarea name="biographie" rows="4" class="bg-gray-50 border border-gray-200 text-sm rounded-lg w-full p-3 focus:ring-kzz-blue focus:border-kzz-blue shadow-inner" placeholder="Décrivez le parcours du dirigeant..."></textarea>
                </div>
                <div class="bg-blue-50 p-4 rounded-xl border-2 border-dashed border-blue-100">
                    ...
                    <input type="file" name="photo" accept="image/*" class="block w-full text-sm text-gray-900 cursor-pointer bg-white rounded-lg p-2 border border-blue-200">
                </div>
            </div>
