...
@section('title', 'Nouveau Membre - ONG ESPOIR GLOBAL')
    ...
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 mb-6">
            <div class="w-full md:w-auto">
                <h1 class="text-2xl font-bold text-kzz-black">Enregistrement d'un Nouveau Membre</h1>
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="numero_membre" class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue focus:border-kzz-blue" placeholder="Ex: EG-RDC-2026-001" required>
                            </div>

                            <div class="md:col-span-2">
                                <label class="block mb-2 text-sm font-bold text-gray-700">Nom Complet (Nom, Postnom, Prénom)</label>
                                <input type="text" name="nom_complet" class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue focus:border-kzz-blue" placeholder="Ex: MUTOMBO MPOYO SARAH" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="date_naissance" class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue">
                            </div>

                            <div>
                                <label class="block mb-2 text-sm font-bold text-gray-700">Lieu de Naissance</label>
                                <input type="text" name="lieu_naissance" class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue" placeholder="Ex: Kinshasa">
                            </div>

                            <div>
                                <label class="block mb-2 text-sm font-bold text-gray-700">Profession</label>
                                <input type="text" name="profession" class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue" placeholder="Ex: Avocat, Étudiant...">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-200">
                        ...
                        <div>
                            ...
                            <textarea name="adresse_membre" rows="3" class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue" placeholder="N°, Avenue, Quartier, Commune, Ville..."></textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select name="type_membre" class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue font-semibold text-blue-900">
                                    <option value="Membre effectif">Membres effectifs</option>
                                    <option value="Membre sympathisant">Membres sympathisants</option>
                                    <option value="Membre d’honneur">Membres d’honneur</option>
                                </select>
                            </div>

                            <div>
                                <label class="block mb-2 text-sm font-bold text-gray-700">Fonction / Titre</label>
                                <input type="text" name="fonction" class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue" placeholder="Ex: Coordinateur, Secrétaire..." required>
                            </div>

                            <div>
                                <label class="block mb-2 text-sm font-bold text-gray-700">Qualité (Optionnel)</label>
                                <input type="text" name="qualite" class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue" placeholder="Ex: Fondateur, Donateur...">
                            </div>

                            <div>
                                <label class="block mb-2 text-sm font-bold text-gray-700">Date d'Adhésion</label>
                                <input type="date" name="date_adhesion" value="{{ date('Y-m-d') }}" class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue">
                            </div>
                        </div>
                    </div>
...
<script>
    // Script de prévisualisation de la photo
