...
@section('content')
    <section class="bg-gray-50 p-3 sm:p-5 min-h-screen">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 mb-6">
                ...
                <div
                    ...
                    <a href="{{ route('membres.index') }}"
                        class="flex items-center justify-center text-gray-700 bg-white border border-gray-300 hover:bg-gray-100 font-medium rounded-lg text-sm px-4 py-2 transition-all">
            ...
            <form action="{{ isset($membre) ? route('membres.update', $membre) : route('membres.store') }}" method="POST"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-200">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="numero_membre"
                                        value="{{ old('numero_membre', $membre->numero_membre ?? '') }}"
                                        class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue focus:border-kzz-blue"
                                        placeholder="Ex: EG-RDC-2026-001" required>
                                </div>

                                <div class="md:col-span-2">
                                    <label class="block mb-2 text-sm font-bold text-gray-700">Nom Complet (Nom, Postnom,
                                        Prénom)</label>
                                    <input type="text" name="nom_complet"
                                        value="{{ old('nom_complet', $membre->nom_complet ?? '') }}"
                                        class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue focus:border-kzz-blue"
                                        placeholder="Ex: MUTOMBO MPOYO SARAH" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="genre"
                                        ...
                                        <option value="Masculin"
                                            {{ old('genre', $membre->genre ?? '') == 'Masculin' ? 'selected' : '' }}>
                                            Masculin</option>
                                        <option value="Féminin"
                                            {{ old('genre', $membre->genre ?? '') == 'Féminin' ? 'selected' : '' }}>Féminin
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="date_naissance"
                                        value="{{ old('date_naissance', $membre->date_naissance ?? '') }}"
                                        class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="profession"
                                        ...
                                        class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue"
                                        placeholder="Ex: Avocat, Étudiant...">
                                </div>

                                <div>
                                    <label class="block mb-2 text-sm font-bold text-gray-700">État Civil</label>
                                    <select name="etat_civil"
                                        class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue">
                                        <option value="">Sélectionner...</option>
                                        <option value="Célibataire"
                                            {{ old('etat_civil', $membre->etat_civil ?? '') == 'Célibataire' ? 'selected' : '' }}>
                                            Célibataire</option>
                                        <option value="Marié"
                                            {{ old('etat_civil', $membre->etat_civil ?? '') == 'Marié' ? 'selected' : '' }}>
                                            Marié
                                        </option>
                                        <option value="Divorcé"
                                            {{ old('etat_civil', $membre->etat_civil ?? '') == 'Divorcé' ? 'selected' : '' }}>
                                            Divorcé
                                        </option>
                                        <option value="Veuf/Veuve"
                                            {{ old('etat_civil', $membre->etat_civil ?? '') == 'Veuf/Veuve' ? 'selected' : '' }}>
                                            Veuf/Veuve
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-200">
                            ...
                            <div>
                                <label class="block mb-2 text-sm font-bold text-gray-700">Adresse de résidence
                                    complète</label>
                                {{-- Note: Les textarea n'ont pas d'attribut value --}}
                                <textarea name="adresse_membre" rows="3"
                                    class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue"
                                    placeholder="N°, Avenue, Quartier, Commune, Ville...">{{ old('adresse_membre', $membre->adresse_membre ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select name="type_membre"
                                        class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue font-semibold text-blue-900">
                                        @php $tm = old('type_membre', $membre->type_membre ?? ''); @endphp
                                        <option value="Membre effectif" {{ $tm == 'Membre effectif' ? 'selected' : '' }}>
                                            Membres effectifs</option>
                                        <option value="Membre sympathisant"
                                            {{ $tm == 'Membre sympathisant' ? 'selected' : '' }}>Membres sympathisants
                                        </option>
                                        <option value="Membre d’honneur" {{ $tm == 'Membre d’honneur' ? 'selected' : '' }}>
                                            Membres d’honneur</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="fonction"
                                        ...
                                        class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue"
                                        placeholder="Ex: Coordinateur, Secrétaire..." required>
                                </div>

                                <div>
                                    <label class="block mb-2 text-sm font-bold text-gray-700">Domaine d'activité
                                        (Optionnel)</label>
                                    <input type="text" name="qualite"
                                        value="{{ old('qualite', $membre->qualite ?? '') }}"
                                        class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue"
                                        placeholder="Ex: Fondateur, Donateur...">
                                </div>

                                <div>
                                    <label class="block mb-2 text-sm font-bold text-gray-700">Date d'Adhésion</label>
                                    <input type="date" name="date_adhesion"
                                        value="{{ old('date_adhesion', $membre->date_adhesion ?? date('Y-m-d')) }}"
                                        class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-kzz-blue">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-200 text-center">
                            ...
                            <div class="flex flex-col items-center">
                                <div
                                    class="w-32 h-32 mb-4 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-gray-50 overflow-hidden">
                                    @if (isset($membre) && $membre->photo_membre)
                                        <img id="preview" src="{{ asset('storage/' . $membre->photo_membre) }}"
                                            alt="Aperçu" class="w-full h-full object-cover">
                                        <svg id="placeholder_svg" class="hidden w-12 h-12 text-gray-400" fill="none"
                                    ...
                                    @else
                                        ...
                                        <svg id="placeholder_svg" class="w-12 h-12 text-gray-400" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                        </svg>
                                ...
                                <input type="file" name="photo_membre" id="image_input"
                        ...
                        <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-200 text-center">
                            <h2 class="text-lg font-semibold text-kzz-blue mb-4 border-b pb-2">Pièce d'Identité</h2>
                            <div class="flex flex-col items-center">
                                <div class="w-full mb-4">
                                    <input type="file" name="piece_identite" id="piece_identite_input"
                                        class="text-xs text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100"
                                        accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
                                    <p class="text-xs text-gray-500 mt-2">Formats acceptés: PDF, JPG, PNG, DOC, DOCX</p>
                                    @if (isset($membre) && $membre->piece_identite)
                                        <p class="text-xs text-green-600 mt-1">Fichier actuel:
                                            {{ basename($membre->piece_identite) }}</p>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="submit"
                            class="w-full py-4 bg-kzz-green hover:bg-green-700 text-white font-bold rounded-lg shadow-lg transition-all flex items-center justify-center">
