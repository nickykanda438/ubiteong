...
<section class="bg-kzz-gray min-h-screen font-sans">
    ...
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12 -mt-16 relative z-20 pb-20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
            <div class="flex items-center p-4 bg-white rounded-xl shadow-lg border-b-4 border-blue-500 transition-transform hover:-translate-y-1">
            ...
            <div class="flex items-center p-4 bg-white rounded-xl shadow-lg border-b-4 border-green-500 transition-transform hover:-translate-y-1">
            ...
            <div class="flex items-center p-4 bg-white rounded-xl shadow-lg border-b-4 border-yellow-500 transition-transform hover:-translate-y-1">
            ...
            <div class="flex items-center p-4 bg-white rounded-xl shadow-lg border-b-4 border-purple-500 transition-transform hover:-translate-y-1">
            ...
            <div class="flex items-center p-4 bg-white rounded-xl shadow-lg border-b-4 border-pink-500 transition-transform hover:-translate-y-1">
                        ...
                        <tr class="bg-white hover:bg-blue-50/40 transition-colors">
                            <th scope="row" class="px-6 py-4 font-semibold text-gray-900 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    @else
                                        <div class="w-10 h-10 rounded-full bg-blue-100 mr-3 flex items-center justify-center text-xs font-black text-blue-800 ring-2 ring-blue-50">
                                            {{ strtoupper(substr($membre->nom_complet, 0, 2)) }}
                                        </div>
                                    @endif
                                    <div class="flex flex-col">
                                        <span class="text-base text-gray-800 font-bold tracking-tight">{{ $membre->nom_complet }}</span>
                            ...
                            <td class="px-6 py-4 flex items-center justify-end space-x-2">
                                ...
                                <a href="{{ route('membres.generateCard', $membre) }}" title="Générer Carte QR" class="p-2 text-gray-400 hover:text-blue-800 hover:bg-blue-50 rounded-lg transition-all">
