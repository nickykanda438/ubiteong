    ...
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
        ...
        <div class="mb-6 p-4 bg-white rounded-lg shadow-sm border-l-4 border-kzz-blue">
            ...
            <p class="text-gray-600 text-sm italic">
                Les membres sont le moteur de notre ONG. Leur engagement permet de concrétiser nos projets sur le terrain et d'assurer la pérennité de nos actions sociales. Chaque profil apporte une expertise unique au service de la communauté.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div class="flex items-center p-4 bg-white rounded-lg shadow border border-gray-100">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-700">1,250</p>
                </div>
            </div>
            <div class="flex items-center p-4 bg-white rounded-lg shadow border border-gray-100">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-700">840</p>
                </div>
            </div>
            <div class="flex items-center p-4 bg-white rounded-lg shadow border border-gray-100">
                ...
                <div>
                    <p class="mb-1 text-sm font-medium text-gray-600">Adhérents</p>
                    <p class="text-lg font-semibold text-gray-700">310</p>
                </div>
            </div>
            <div class="flex items-center p-4 bg-white rounded-lg shadow border border-gray-100">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-700">100</p>
                </div>
            </div>
        </div>
                ...
                <div class="w-full md:w-1/2">
                    <form class="flex items-center">
                        <div class="relative w-full">
                            ...
                            <input type="text" class="bg-gray-50 border border-gray-300 text-kzz-black text-sm rounded-lg focus:ring-kzz-blue focus:border-kzz-blue block w-full pl-10 p-2" placeholder="Rechercher un membre...">
                        </div>
                    </form>
                </div>
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <a href="#" class="flex items-center justify-center text-white bg-kzz-green hover:bg-green-700 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 transition-all">
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-white uppercase bg-kzz-blue font-title">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Qualité</th>
                        ...
                        <tr class="border-b hover:bg-gray-50 transition-colors">
                            <th scope="row" class="px-4 py-3 font-semibold text-kzz-black whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-8 h-8 rounded-full bg-gray-200 mr-3 flex items-center justify-center text-xs font-bold text-gray-500">AM</div>
                                    Arick Mutshipay
                                </div>
                            </th>
                            <td class="px-4 py-3">Membre Effectif</td>
                            <td class="px-4 py-3">Masculin</td>
                            <td class="px-4 py-3">
                                <span class="bg-blue-100 text-kzz-blue text-xs font-medium px-2 py-0.5 rounded">Fondateur</span>
                            </td>
                            <td class="px-4 py-3 flex items-center justify-end space-x-2">
                                <button title="Voir la carte" class="p-1 text-gray-500 hover:text-blue-600">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" /></svg>
                                </button>
                                <button title="Modifier" class="p-1 text-gray-500 hover:text-yellow-600">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                                </button>
                                <button title="Supprimer" class="p-1 text-gray-500 hover:text-red-600">
