...
<body class="bg-kzz-gray font-sans antialiased">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <button data-drawer-target="sidebar" data-drawer-toggle="sidebar"
                        class="p-2 text-white rounded-lg sm:hidden hover:bg-blue-800">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 6h16M4 12h16M4 18h10"></path>
                        </svg>
                    </button>
                    <span class="ms-4 text-xl font-title font-bold text-white uppercase tracking-wider">Fondation
                        KAZWAZWA</span>
                </div>
    ...
    <aside id="sidebar"
        class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-kzz-blue sm:translate-x-0 border-r border-blue-900">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-kzz-blue">
            <ul class="space-y-1 font-medium">
                ...
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-white rounded-lg hover:bg-white/10 group transition"
                        ...
                        <svg class="w-3 h-3 text-white" fill="none" viewBox="0 0 10 6">
                    ...
                    <ul id="drop-m" class="py-2 space-y-1 bg-blue-900/30 rounded-lg mt-1">
                        <li><a href="{{ route('membres.index') }}"
                                class="block p-2 pl-11 text-xs text-blue-100 hover:text-white hover:bg-white/5 transition font-sans italic">Liste
                                des membres</a></li>
                        <li><a href="{{ route('membres.create') }}"
                                class="block p-2 pl-11 text-xs text-blue-100 hover:text-white hover:bg-white/5 transition font-sans italic">Enregistrement</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="{{ route('documents.index') }}"
                        class="flex items-center p-2 text-white rounded-lg hover:bg-white/10 group">
                        <svg class="w-5 h-5 text-gray-300 group-hover:text-white" fill="currentColor"
                            viewBox="0 0 20 20">
                ...
                <li>
                    <a href="{{ route('communication.index') }}"
                        class="flex items-center p-2 text-white rounded-lg hover:bg-white/10 group transition duration-75">
                        <svg class="w-5 h-5 text-gray-300 group-hover:text-white" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path
                        ...
                        <span class="ms-3 font-sans">Communication</span>
                    </a>
                </li>
                <li class="pt-4">
                    <a href="{{ route('finance.index') }}"
                        class="flex items-center p-3 text-white bg-kzz-green rounded-xl shadow-lg hover:bg-opacity-90 transition transform hover:scale-[1.02]">
